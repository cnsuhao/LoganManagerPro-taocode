...
public:
    ...
    static void ReloadSkin();	// ZIP文件或本地文件换肤函数
    ...
    const TImageInfo* GetImageEx(LPCTSTR bitmap, LPCTSTR type = NULL, DWORD mask = 0, bool gray = false);
    const TImageInfo* AddImage(LPCTSTR bitmap, LPCTSTR type = NULL, DWORD mask = 0,bool gray = false);
