    ...
    for( CMarkupNode node = pRoot->GetChild() ; node.IsValid(); node = node.GetSibling() ) {
		...
		else if( _tcscmp(pstrClass, _T("TreeNode")) == 0 )
		{
            ...
            case 8:
				...
				else if( _tcscmp(pstrClass, DUI_CTR_FILELIST) == 0 )		  pControl = new CFileListUI;
            ...
            case 9:
				...
				else if( _tcscmp(pstrClass, DUI_CTR_COMBOEDIT) == 0 )		  pControl = new CComboEditUI;
			...
			case 11:
				...
				break;
			case 13:
				if (_tcscmp(pstrClass, DUI_CTR_ANIMATIONCTRL) == 0)			  pControl = new CAnimationCtrlUI;
				break;
            case 14:
