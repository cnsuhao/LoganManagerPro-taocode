...
public:
    ...
    static TImageInfo* LoadImage(STRINGorID bitmap, LPCTSTR type = NULL, DWORD mask = 0,bool gray = false/*加灰*/);
    ...
    // 以下函数中的颜色参数alpha值无效
    static void DrawLine(HDC hDC, const RECT& rc, int nSize, DWORD dwPenColor,int nStyle = PS_SOLID,bool bLeftToRight=true);
    static void DrawRect(HDC hDC, const RECT& rc, int nSize, DWORD dwPenColor);
    static void DrawEllipse(HDC hDC,const RECT&rc,int nSize, DWORD dwPenColor,bool fill=false,DWORD dwFillColor=0);
