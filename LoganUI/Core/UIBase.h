...
public:
    ...
    void CenterWindow();			// 居中
	virtual void FullScreen();		// 全屏
	virtual void RestoreScreen();	// 全屏后恢复
...
protected:
	...
	virtual LRESULT OnGetMinMaxInfo( HWND hwnd, LPMINMAXINFO lpMinMaxInfo); // 处理这个消息是为了全屏显示
